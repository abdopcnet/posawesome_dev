...
frappe.ui.form.on('POS Offer', {
	...
	validate: function (frm) {
		console.info('[INFO] validate called');
		try {
	...
	apply_on: function (frm) {
		console.info('[INFO] apply_on changed');
		controllers(frm);
	},
	offer: function (frm) {
		console.info('[INFO] offer changed');
		controllers(frm);
	},
	apply_type: function (frm) {
		console.info('[INFO] apply_type changed');
		controllers(frm);
	},
	discount_type: function (frm) {
		console.info('[INFO] discount_type changed');
		controllers(frm);
	},
	replace_item: function (frm) {
		console.info('[INFO] replace_item changed');
		controllers(frm);
	},
	replace_cheapest_item: function (frm) {
		console.info('[INFO] replace_cheapest_item changed');
		controllers(frm);
	},
});
...
const controllers = (frm) => {
	console.info('[INFO] controllers called');
...
const set_filters = (frm) => {
	console.info('[INFO] set_filters called');
