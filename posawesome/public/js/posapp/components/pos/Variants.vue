...
export default {
  ...
  methods: {
    close_dialog() {
      console.info('[Variants] close_dialog called');
    ...
    formatCurrency(value) {
      try {
        ...
        console.error('[Variants] Error in formatCurrency:', error);
        return value;
      }
    },
    updateFiltredItems() {
      try {
        console.info('[Variants] updateFiltredItems called', this.filters);
        ...
        console.error('[Variants] Error in updateFiltredItems:', error);
      }
    },
    add_item(item) {
      try {
        console.info('[Variants] add_item called', item);
        evntBus.emit('add_item', item);
        this.close_dialog();
      } catch (error) {
        console.error('[Variants] Error in add_item:', error);
      }
    },
  },
  ...
  created: function () {
    try {
      console.info('[Variants] created hook');
      evntBus.on('open_variants_model', (item, items) => {
        console.info('[Variants] open_variants_model event', { item, items });
      ...
      console.error('[Variants] Error in created hook:', error);
    }
  },
};
</script>
